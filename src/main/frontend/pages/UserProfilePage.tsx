      ...
      <Card>
        <div className="md:flex md:space-x-8">
          <div className="md:w-1/3 text-center mb-6 md:mb-0">
            <img 
              src={user.profilePictureUrl || `https://picsum.photos/seed/${user.id}/200/200`} 
              alt={user.name} 
          ...
          <div className="md:w-2/3">
            ...
            {user.bio && (
              <div className="mb-6">
                ...
                <p className="text-neutral-600 whitespace-pre-line">{user.bio}</p>
              </div>
            )}
            ...
            {user.preferredStyle && (
              <div className="mb-6">
                ...
                <p className="text-neutral-600 whitespace-pre-line">{user.preferredStyle}</p>
              </div>
            )}
            ...
            {user.avoidedStyle && (
              <div className="mb-6">
                ...
                <p className="text-neutral-600 whitespace-pre-line">{user.avoidedStyle}</p>
              </div>
            )}
